   ...
   <div id="comment-<?php comment_ID(); ?>" class="comment-body clearfix">
...
</a><?php edit_comment_link(__('(Edit)','13floor'),'  ','') ?></div>
			</div>
		</div>
		...
		<div class="comment-wrap">
			...
			<?php if ($comment->comment_approved == '0') : ?>
				<em class="moderation"><?php _e('Your comment is awaiting moderation.','13floor') ?></em>
				<br />
			<?php endif; ?>
			
		    <div class="comment-content"><?php comment_text() ?></div> <!-- end comment-content-->
		    <div class="reply-container"><?php comment_reply_link(array_merge( $args, array('reply_text' => __('Reply','13floor'),'depth' => $depth, 'max_depth' => $args['max_depth']))) ?></div>
