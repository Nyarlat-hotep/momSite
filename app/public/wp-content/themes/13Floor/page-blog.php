						...
						<div id="et_pt_blog">
							...
							<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
								...
								<div class="et_pt_blogentry clearfix">
									...
									<p class="et_pt_blogmeta"><?php _e('Posted','13floor'); ?> <?php _e('by','13floor'); ?> <?php the_author_posts_link(); ?> <?php _e('on','13floor'); ?> <?php the_time(get_option('13floor_date_format')) ?> <?php _e('in','13floor'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','13floor'), __('1 comment','13floor'), '% '.__('comments','13floor')); ?></p>
									...
									<?php if (!$et_ptemplate_blogstyle) { ?>
										...
										<a href="<?php the_permalink(); ?>" class="readmore"><span><?php _e('read more','13floor'); ?></span></a>
									<?php } else { ?>
										<?php the_content(''); ?>
									<?php } ?>
