...
// Project related.
var project                 = 'marshaTheme'; // Project Name.
var projectURL              = 'http://local.mr.com'; // Project URL. Could be something like localhost:8888.
...
// Style related.
var styleSRC                = './style.scss'; // Path to main .scss file.
var styleDestination        = './'; // Path to place the compiled CSS file.
// Default set to root folder.

// JS Vendor related.
// var jsVendorSRC             = './vendors/**/*.js'; // Path to JS vendor folder.
...
// Watch files paths.
var styleWatchFiles         = './style.scss'; // Path to all *.scss files inside css folder and inside them.
